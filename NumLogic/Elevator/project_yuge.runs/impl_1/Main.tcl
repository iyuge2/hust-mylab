...
set rc [catch {
  ...
  set_property ip_repo_paths d:/iyuge2/project_yuge/project_yuge.cache/ip [current_project]
  set_property ip_output_repo d:/iyuge2/project_yuge/project_yuge.cache/ip [current_project]
  add_files -quiet D:/iyuge2/project_yuge/project_yuge.runs/synth_1/Main.dcp
